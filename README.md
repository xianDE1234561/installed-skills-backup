...
| [installed-skills-backup-20260815.zip](./installed-skills-backup-20260815.zip) | Complete backup archive captured on 2026-08-15, including the currently installed skills. |
...
- For a full restore, download the dated ZIP archive and extract it into the corresponding Codex/agent skill roots.
- Keep future full archives named \`installed-skills-backup-YYYYMMDD.zip\` so snapshots remain easy to identify.
